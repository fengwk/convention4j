...
public class ToolChatClient implements ChatClient {
    ...
    private final ToolFunctionHandlersView handlersView;

    public ToolChatClient(ChatClient delegate, ToolFunctionHandlersView handlersView) {
        this.delegate = Objects.requireNonNull(delegate);
        this.handlersView = handlersView;
    }
        ...
        while (ChatUtils.isToolCalls(response)) {
            ...
            for (ChatToolCall toolCall : toolCalls) {
                if (ChatUtils.isFunctionCall(toolCall)) {
                    ...
                    ToolFunctionHandler handler = handlersView.getHandlerRequired(function.getName());
    ...
    private void setTools(ChatRequest chatRequest) {
        chatRequest.setTools(ChatUtils.getTools(handlersView));
    }
