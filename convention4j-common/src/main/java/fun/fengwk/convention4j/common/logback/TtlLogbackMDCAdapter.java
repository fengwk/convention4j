package fun.fengwk.convention4j.common.logback;
...
public class TtlLogbackMDCAdapter extends LogbackMDCAdapter {
    ...
    final TransmittableThreadLocal<Map<String, String>> readWriteThreadLocalMap = new TransmittableThreadLocal<>();
    final TransmittableThreadLocal<Map<String, String>> readOnlyThreadLocalMap = new TransmittableThreadLocal<>();
    private final TtlMapOfStacks threadLocalMapOfDeques = new TtlMapOfStacks();
