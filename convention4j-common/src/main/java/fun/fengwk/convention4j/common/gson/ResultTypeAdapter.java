...
import fun.fengwk.convention4j.common.result.ResultImpl;
...
public class ResultTypeAdapter implements GsonTypeAdapter<Result<?>> {
    ...
    public Result<?> deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
        if (json == null || json.isJsonNull()) {
            ...
            ImmutableMap<String, Object> errors = deserializeErrors(jsonObject.get(PROPERTY_ERRORS), context);
    ...
    private ImmutableMap<String, Object> deserializeErrors(JsonElement jsonEle, JsonDeserializationContext context) {
        if (jsonEle == null || jsonEle.isJsonNull()) {
            return null;
        }
        
        return context.deserialize(jsonEle, new TypeToken<ImmutableMap<String, Object>>() {}.getType());
    }
