 ...
 * @see <a href="https://github.com/kptfh/gzip-reactive/blob/master/gzip-nonblocking/src/main/java/reactivegzip/NonblockingGzipDecoder.java">
 *     NonblockingGzipDecoder.java</a>
 */
